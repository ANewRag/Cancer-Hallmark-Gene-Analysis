...
# Example Usage
source_folder <- "/Users/junninghu/Downloads/Compbio_project/Kidney Renal Papillary Cell Carcinoma/gdc_download_20250418_163226.131000"  # Replace with the path to the source folder containing subfolders
target_folder <- "/Users/junninghu/Downloads/Compbio_project/Kidney Renal Papillary Cell Carcinoma"  # Replace with the path to the folder where you want all the files
